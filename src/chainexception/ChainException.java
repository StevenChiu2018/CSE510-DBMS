...
/**
 * This class is used for error handling. Errors are traced from different layer of the minibase
 * system.
 */
public class ChainException extends Exception {
  ...
  /**
   * Default constructor. It will probably never be used since every exception should be pushed onto
   * the stack.
   */
