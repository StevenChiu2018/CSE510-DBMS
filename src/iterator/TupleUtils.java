...
public class TupleUtils {
  ...
  /**
   * This function compares a tuple with another tuple in respective field, and returns:
   *
   ...
   * @return 0 if the two are equal, 1 if the tuple is greater, -1 if the tuple is smaller,
   */
  public static int CompareTupleWithTuple(AttrType fldType, Tuple t1, int t1_fld_no, Tuple t2,
   ...
   * @exception TupleUtilsException exception from this class
   */
  public static short[] setup_op_tuple(Tuple Jtuple, AttrType[] res_attrs, AttrType in1[],
      int len_in1, AttrType in2[], int len_in2, short t1_str_sizes[], short t2_str_sizes[],
  ...
  public static short[] setup_op_tuple(Tuple Jtuple, AttrType res_attrs[], AttrType in1[],
      int len_in1, short t1_str_sizes[], FldSpec proj_list[], int nOutFlds)
