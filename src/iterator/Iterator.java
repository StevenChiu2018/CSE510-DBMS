...
public abstract class Iterator implements Flags {
  ...
  /**
   * a flag to indicate whether this iterator has been closed. it is set to true the first time the
   * <code>close()</code> function is called. multiple calls to the <code>close()</code> function
